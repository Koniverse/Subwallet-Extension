...
import { ALL_ACCOUNT_KEY, ASSET_HUB_CHAIN_SLUGS, HYDRATION_CHAIN_SLUGS, LATEST_SESSION } from '@subwallet/extension-base/constants';
...
export default class KoniExtension {
  ...
  private async getTokensCanPayFee (request: RequestGetTokensCanPayFee): Promise<TokenHasBalanceInfo[]> {
    ...
    } else if (HYDRATION_CHAIN_SLUGS.includes(chain)) {
